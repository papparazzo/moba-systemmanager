...
int main(int argc, char *argv[]) {
    ...
    auto endpoint = EndpointPtr{new Endpoint{socket, appData.appName, "systemmanager", appData.version, {Message::SERVER, Message::SYSTEM, Message::MESSAGING, Message::TIMER}}};
